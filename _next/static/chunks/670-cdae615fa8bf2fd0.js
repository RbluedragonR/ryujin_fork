(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [670], {
        ...
        4080: function(e, t, n) {
            ...
            let r = n(9920),
                ...
                h = e => {
                    ...
                    for (let [n, r] of (l ? (m.innerHTML = l.__html || "", _()) : o ? (m.textContent = "string" == typeof o ? o : Array.isArray(o) ? o.join("") : "", _()) : t && (m.src = t, d.set(t, b)), Object.entries(e))) {
            ...
            function b(e) {
                ...
                let M = (0, i.useRef)(!1);
                if ((0, i.useEffect)(() => {
                        !M.current && ("afterInteractive" === s ? h(e) : "lazyOnload" === s && ("complete" === document.readyState ? (0, c.requestIdleCallback)(() => h(e)) : window.addEventListener("load", () => {
                            (0, c.requestIdleCallback)(() => h(e))
                        })), M.current = !0)
                    }, [e, s]), ("beforeInteractive" === s || "worker" === s) && (_ ? (m[s] = (m[s] || []).concat([{
                        id: t,
                        src: n,
                        onLoad: r,
                        onReady: a,
        ...
        851: function(e) {
            e.exports = {
                style: {
                    fontFamily: "'__satoshi_ba7a58', '__satoshi_Fallback_ba7a58'"
                },
                className: "__className_ba7a58"
            }
        }
    }
]);